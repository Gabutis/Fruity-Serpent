...
def game_state_menu(auto_move):
    ...
    screen.blit(leaderboard_button_border, (settings.WIDTH // 2 - leaderboard_button.get_width() // 2 - 2, settings.HEIGHT // 2 + 100))
    screen.blit(leaderboard_button_border, (settings.WIDTH // 2 - leaderboard_button.get_width() // 2 + 2, settings.HEIGHT // 2 + 100))
    screen.blit(leaderboard_button_border, (settings.WIDTH // 2 - leaderboard_button.get_width() // 2, settings.HEIGHT // 2 + 100 - 2))
    screen.blit(leaderboard_button_border, (settings.WIDTH // 2 - leaderboard_button.get_width() // 2, settings.HEIGHT // 2 + 100 + 2))
    screen.blit(leaderboard_button, (settings.WIDTH // 2 - leaderboard_button.get_width() // 2, settings.HEIGHT // 2 + 100))

    screen.blit(exit_button_border, (settings.WIDTH // 2 - exit_button.get_width() // 2 - 2, settings.HEIGHT // 2 + 150))
    screen.blit(exit_button_border, (settings.WIDTH // 2 - exit_button.get_width() // 2 + 2, settings.HEIGHT // 2 + 150))
    screen.blit(exit_button_border, (settings.WIDTH // 2 - exit_button.get_width() // 2, settings.HEIGHT // 2 + 150 - 2))
    screen.blit(exit_button_border, (settings.WIDTH // 2 - exit_button.get_width() // 2, settings.HEIGHT // 2 + 150 + 2))
    screen.blit(exit_button, (settings.WIDTH // 2 - exit_button.get_width() // 2, settings.HEIGHT // 2 + 150))
...
def game_state_name_input(player_name, is_name_required):
    ...
    input_text_border = input_font.render("Enter your name and press ENTER:", True, settings.GREEN)
    input_text = input_font.render("Enter your name and press ENTER:", True, settings.PURPLE)
    ...
    return input_text, player_name_text
